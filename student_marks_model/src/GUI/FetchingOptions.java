 ...
 * @author anubrata
 */
public class FetchingOptions extends javax.swing.JFrame {

    /**
     * Creates new form FetchingOptions
     */
    public FetchingOptions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Average Marks");
        ...
        jButton2.setText("Maximum Marks");
        ...
        jButton4.setText("Students Failed");
        ...
        jButton5.setText("Generate Marks-Sheet");
        ...
        jButton6.setText("Absent Student");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FetchingOptions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FetchingOptions().setVisible(true);
            }
        });
    }
